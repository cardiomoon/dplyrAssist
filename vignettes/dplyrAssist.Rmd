...
1. Highlight a symbol naming a `data.frame` or a `tibble` in your R session, e.g. `iris`
...
3. When you're done, the code for data manipulation will be emitted at the cursor position.
